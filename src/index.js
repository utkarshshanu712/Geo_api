...
const Coordinates = {
	...
	Algeria: {
		...
		longitude: 1.6596,
		subDistricts: {
			Adrar: { latitude: 27.0, longitude: -0.0 },
			Chlef: { latitude: 36.0, longitude: 1.0 },
			Laghouat: { latitude: 33.0, longitude: 2.0 },
			OumElBouaghi: { latitude: 35.0, longitude: 7.0 },
			Batna: { latitude: 35.0, longitude: 5.0 },
			Béjaïa: { latitude: 36.0, longitude: 5.0 },
			Biskra: { latitude: 34.0, longitude: 5.0 },
			Béchar: { latitude: 31.0, longitude: -2.0 },
			Tébessa: { latitude: 35.0, longitude: 8.0 },
			Tlemcen: { latitude: 34.0, longitude: -1.0 },
			Algiers: { latitude: 36.7538, longitude: 3.0588 },
			Oran: { latitude: 35.7, longitude: -0.6 },
			Annaba: { latitude: 36.9, longitude: 7.75 },
			Constantine: { latitude: 36.0, longitude: 6.0 },
			Médéa: { latitude: 36.0, longitude: 2.0 },
			Mostaganem: { latitude: 35.0, longitude: 0.0 },
			Sétif: { latitude: 36.0, longitude: 5.0 },
			TiziOuzou: { latitude: 36.0, longitude: 4.0 },
			Naama: { latitude: 33.0, longitude: -1.0 },
			ElOued: { latitude: 33.0, longitude: 6.0 },
			Tindouf: { latitude: 25.0, longitude: -13.0 },
			Ghardaïa: { latitude: 32.0, longitude: 3.0 },
			Illizi: { latitude: 26.0, longitude: 9.0 },
			Tamanrasset: { latitude: 22.0, longitude: 5.0 },
			ElBayadh: { latitude: 33.0, longitude: -1.0 },
			Relizane: { latitude: 35.0, longitude: 1.0 },
		},
	},
	Angola: {
		latitude: -11.2027,
		longitude: 17.8739,
		subDistricts: {
			Bengo: { latitude: -8.0, longitude: 14.0 },
			Benguela: { latitude: -12.0, longitude: 13.0 },
			Bié: { latitude: -12.0, longitude: 17.0 },
			Cabinda: { latitude: -5.0, longitude: 12.0 },
			CuandoCubango: { latitude: -15.0, longitude: 18.0 },
			CuanzaNorte: { latitude: -9.0, longitude: 14.0 },
			CuanzaSul: { latitude: -10.0, longitude: 14.0 },
			Cunene: { latitude: -17.0, longitude: 14.0 },
			Huambo: { latitude: -12.0, longitude: 15.0 },
			Huíla: { latitude: -15.0, longitude: 14.0 },
			Luanda: { latitude: -8.0, longitude: 13.0 },
			LundaNorte: { latitude: -7.0, longitude: 20.0 },
			LundaSul: { latitude: -9.0, longitude: 20.0 },
			Malanje: { latitude: -9.0, longitude: 16.0 },
			Moxico: { latitude: -12.0, longitude: 23.0 },
			Namibe: { latitude: -15.0, longitude: 12.0 },
			Zaire: { latitude: -6.0, longitude: 12.0 },
		},
	},
	Benin: {
		latitude: 9.3076,
		longitude: 2.3158,
		subDistricts: {
			Alibori: { latitude: 11.0, longitude: 3.0 },
			Atakora: { latitude: 10.0, longitude: 1.0 },
			Atlantique: { latitude: 6.0, longitude: 2.0 },
			Borgou: { latitude: 9.0, longitude: 2.0 },
			Collines: { latitude: 8.0, longitude: 2.0 },
			Couffo: { latitude: 7.0, longitude: 1.0 },
			Donga: { latitude: 9.0, longitude: 1.0 },
			Littoral: { latitude: 6.0, longitude: 2.0 },
			Mono: { latitude: 6.0, longitude: 1.0 },
			Ouémé: { latitude: 7.0, longitude: 2.0 },
			Plateau: { latitude: 7.0, longitude: 2.0 },
			Zou: { latitude: 7.0, longitude: 2.0 },
		},
	},
	Botswana: {
		latitude: -22.3285,
		longitude: 24.6849,
		subDistricts: {
			Central: { latitude: -22.0, longitude: 25.0 },
			Gaborone: { latitude: -24.0, longitude: 25.0 },
			Ghanzi: { latitude: -22.0, longitude: 20.0 },
			Kgalagadi: { latitude: -23.0, longitude: 20.0 },
			Kweneng: { latitude: -23.0, longitude: 25.0 },
			NorthEast: { latitude: -22.0, longitude: 25.0 },
			Ngamiland: { latitude: -20.0, longitude: 23.0 },
			SouthEast: { latitude: -24.0, longitude: 25.0 },
			Southern: { latitude: -24.0, longitude: 25.0 },
		},
	},
	BurkinaFaso: {
		latitude: 12.2383,
		longitude: -1.5616,
		subDistricts: {
			BoucleDuMouhoun: { latitude: 12.0, longitude: -2.0 },
			Cascades: { latitude: 10.0, longitude: -3.0 },
			Centre: { latitude: 12.0, longitude: -1.0 },
			CentreEst: { latitude: 12.0, longitude: -1.0 },
			CentreNord: { latitude: 13.0, longitude: -1.0 },
			CentreOuest: { latitude: 12.0, longitude: -2.0 },
			HautsBassins: { latitude: 11.0, longitude: -4.0 },
			Nord: { latitude: 14.0, longitude: -1.0 },
			PlateauCentral: { latitude: 12.0, longitude: -1.0 },
			SudOuest: { latitude: 10.0, longitude: -3.0 },
			Est: { latitude: 12.0, longitude: -1.0 },
		},
	},
	Burundi: {
		latitude: -3.3731,
		longitude: 29.9189,
		subDistricts: {
			BujumburaMairie: { latitude: -3.0, longitude: 29.0 },
			BujumburaRural: { latitude: -3.0, longitude: 29.0 },
			Cankuzo: { latitude: -3.0, longitude: 30.0 },
			Cibitoke: { latitude: -3.0, longitude: 29.0 },
			Gitega: { latitude: -3.0, longitude: 29.0 },
			Karuzi: { latitude: -3.0, longitude: 29.0 },
			Kayanza: { latitude: -3.0, longitude: 29.0 },
			Kirundo: { latitude: -3.0, longitude: 30.0 },
			Makamba: { latitude: -3.0, longitude: 29.0 },
			Muramvya: { latitude: -3.0, longitude: 29.0 },
			Muyinga: { latitude: -3.0, longitude: 30.0 },
			Ngozi: { latitude: -3.0, longitude: 29.0 },
			Rutana: { latitude: -3.0, longitude: 29.0 },
			Ruyigi: { latitude: -3.0, longitude: 30.0 },
		},
	},
	CaboVerde: {
		latitude: 16.002,
		longitude: -24.0132,
		subDistricts: {
			BoaVista: { latitude: 16.0, longitude: -22.0 },
			Brava: { latitude: 15.0, longitude: -24.0 },
			Fogo: { latitude: 14.0, longitude: -24.0 },
			Maio: { latitude: 15.0, longitude: -23.0 },
			Sal: { latitude: 16.0, longitude: -22.0 },
			Santiago: { latitude: 15.0, longitude: -23.0 },
			SantoAntão: { latitude: 17.0, longitude: -25.0 },
			SãoVicente: { latitude: 16.0, longitude: -25.0 },
		},
	},
	Cameroon: {
		latitude: 3.848,
		longitude: 11.5021,
		subDistricts: {
			Adamawa: { latitude: 6.0, longitude: 12.0 },
			Centre: { latitude: 3.0, longitude: 11.0 },
			East: { latitude: 4.0, longitude: 14.0 },
			FarNorth: { latitude: 10.0, longitude: 14.0 },
			Littoral: { latitude: 4.0, longitude: 9.0 },
			North: { latitude: 8.0, longitude: 12.0 },
			NorthWest: { latitude: 5.0, longitude: 10.0 },
			South: { latitude: 4.0, longitude: 10.0 },
			SouthWest: { latitude: 4.0, longitude: 9.0 },
		},
	},
	CentralAfricanRepublic: {
		...
		longitude: 18.558,
		subDistricts: {
			BaminguiBangoran: { latitude: 6.0, longitude: 19.0 },
			Bangui: { latitude: 4.0, longitude: 18.0 },
			BasseKotto: { latitude: 4.0, longitude: 20.0 },
			HauteKotto: { latitude: 5.0, longitude: 20.0 },
			Kemo: { latitude: 5.0, longitude: 19.0 },
			Lobaye: { latitude: 4.0, longitude: 18.0 },
			MambereKadei: { latitude: 5.0, longitude: 17.0 },
			NanaMambere: { latitude: 5.0, longitude: 16.0 },
			Ouham: { latitude: 6.0, longitude: 17.0 },
			OuhamPendé: { latitude: 6.0, longitude: 17.0 },
			SanghaMbaéré: { latitude: 4.0, longitude: 15.0 },
			Vakaga: { latitude: 8.0, longitude: 20.0 },
		},
	},
	Chad: {
		latitude: 15.4542,
		longitude: 18.7322,
		subDistricts: {
			Adamaoua: { latitude: 8.0, longitude: 14.0 },
			ChariBaguirmi: { latitude: 12.0, longitude: 16.0 },
			Guéra: { latitude: 13.0, longitude: 18.0 },
			HadjerLamis: { latitude: 12.0, longitude: 16.0 },
			Kanem: { latitude: 13.0, longitude: 14.0 },
			Lac: { latitude: 13.0, longitude: 14.0 },
			LogoneOriental: { latitude: 9.0, longitude: 15.0 },
			LogoneSud: { latitude: 9.0, longitude: 15.0 },
			MayoKebbiEst: { latitude: 8.0, longitude: 15.0 },
			MayoKebbiOuest: { latitude: 8.0, longitude: 15.0 },
			MoyenChari: { latitude: 10.0, longitude: 16.0 },
			N_Djamena: { latitude: 12.0, longitude: 14.0 },
			Ouaddaï: { latitude: 13.0, longitude: 20.0 },
			Salamat: { latitude: 10.0, longitude: 18.0 },
			Tandjilé: { latitude: 8.0, longitude: 16.0 },
			Tchad: { latitude: 15.0, longitude: 18.0 },
			WadiFira: { latitude: 13.0, longitude: 20.0 },
		},
	},
	Comoros: {
		latitude: -11.8751,
		longitude: 43.8722,
		subDistricts: {
			Anjouan: { latitude: -12.0, longitude: 44.0 },
			GrandeComore: { latitude: -11.0, longitude: 43.0 },
			Mohéli: { latitude: -12.0, longitude: 43.0 },
		},
	},
	Congo: {
		latitude: -0.228,
		longitude: 15.8277,
		subDistricts: {
			Bouenza: { latitude: -4.0, longitude: 14.0 },
			Brazzaville: { latitude: -4.0, longitude: 15.0 },
			Cuvette: { latitude: -1.0, longitude: 15.0 },
			CuvetteOuest: { latitude: -1.0, longitude: 15.0 },
			Lékoumou: { latitude: -3.0, longitude: 14.0 },
			Niari: { latitude: -4.0, longitude: 12.0 },
			Plateaux: { latitude: -2.0, longitude: 14.0 },
			PointeNoire: { latitude: -4.0, longitude: 11.0 },
			Sangha: { latitude: -3.0, longitude: 14.0 },
		},
	},
	CongoDemocraticRepublic: {
		...
		longitude: 21.7587,
		subDistricts: {
			BasUele: { latitude: 4.0, longitude: 25.0 },
			HautUele: { latitude: 4.0, longitude: 27.0 },
			Ituri: { latitude: 2.0, longitude: 27.0 },
			Tshopo: { latitude: 5.0, longitude: 26.0 },
			HautLomami: { latitude: -8.0, longitude: 27.0 },
			Lualaba: { latitude: -10.0, longitude: 27.0 },
			Tanganyika: { latitude: -7.0, longitude: 27.0 },
			SudKivu: { latitude: -5.0, longitude: 28.0 },
			Maniema: { latitude: -3.0, longitude: 27.0 },
			Kasaï: { latitude: -5.0, longitude: 23.0 },
			KasaïCentral: { latitude: -5.0, longitude: 23.0 },
			KasaïOriental: { latitude: -5.0, longitude: 23.0 },
			Sankuru: { latitude: -3.0, longitude: 23.0 },
			Lomami: { latitude: -7.0, longitude: 27.0 },
			Tshuapa: { latitude: 2.0, longitude: 20.0 },
			Mongala: { latitude: 2.0, longitude: 20.0 },
			NordKivu: { latitude: 2.0, longitude: 28.0 },
			SudKivu: { latitude: -5.0, longitude: 28.0 },
			Kinshasa: { latitude: -4.0, longitude: 15.0 },
		},
	},
	Djibouti: {
		latitude: 11.8251,
		longitude: 42.5903,
		subDistricts: {
			AliSabieh: { latitude: 11.0, longitude: 42.0 },
			Arta: { latitude: 11.0, longitude: 42.0 },
			Dikhil: { latitude: 11.0, longitude: 42.0 },
			Djibouti: { latitude: 11.0, longitude: 43.0 },
			Obock: { latitude: 11.0, longitude: 43.0 },
			Tadjourah: { latitude: 11.0, longitude: 42.0 },
		},
	},
	Egypt: {
		latitude: 26.8206,
		longitude: 30.8025,
		subDistricts: {
			Alexandria: { latitude: 31.2, longitude: 29.9 },
			Aswan: { latitude: 24.0, longitude: 32.0 },
			Asyut: { latitude: 27.0, longitude: 31.0 },
			Beheira: { latitude: 31.0, longitude: 30.0 },
			BeniSuef: { latitude: 29.0, longitude: 31.0 },
			Cairo: { latitude: 30.0444, longitude: 31.2357 },
			Dakahlia: { latitude: 31.0, longitude: 31.0 },
			Damietta: { latitude: 31.0, longitude: 31.0 },
			Fayoum: { latitude: 29.0, longitude: 30.0 },
			Gharbia: { latitude: 30.0, longitude: 31.0 },
			Giza: { latitude: 30.0, longitude: 31.0 },
			Ismailia: { latitude: 30.0, longitude: 32.0 },
			KafrElSheikh: { latitude: 31.0, longitude: 30.0 },
			Luxor: { latitude: 25.0, longitude: 32.0 },
			Matrouh: { latitude: 31.0, longitude: 27.0 },
			Minya: { latitude: 28.0, longitude: 30.0 },
			PortSaid: { latitude: 31.0, longitude: 32.0 },
			Qalyubia: { latitude: 30.0, longitude: 31.0 },
			Qena: { latitude: 26.0, longitude: 32.0 },
			RedSea: { latitude: 26.0, longitude: 34.0 },
			Sharqia: { latitude: 30.0, longitude: 31.0 },
			Sohag: { latitude: 26.0, longitude: 31.0 },
			SouthSinai: { latitude: 29.0, longitude: 34.0 },
			Suez: { latitude: 30.0, longitude: 32.0 },
		},
	},
	EquatorialGuinea: {
		latitude: 1.65,
		longitude: 10.0,
		subDistricts: {
			Annobón: { latitude: -1.0, longitude: 5.0 },
			BiokoNorte: { latitude: 3.0, longitude: 8.0 },
			BiokoSur: { latitude: 3.0, longitude: 8.0 },
			CentroSur: { latitude: 1.0, longitude: 10.0 },
			Djibloho: { latitude: 1.0, longitude: 10.0 },
			Litoral: { latitude: 1.0, longitude: 9.0 },
			WeleNzas: { latitude: 1.0, longitude: 10.0 },
		},
	},
	Eritrea: {
		latitude: 15.1792,
		longitude: 39.7823,
		subDistricts: {
			Anseba: { latitude: 15.0, longitude: 37.0 },
			Debub: { latitude: 14.0, longitude: 39.0 },
			GashBarka: { latitude: 15.0, longitude: 37.0 },
			Maekel: { latitude: 15.0, longitude: 39.0 },
			Semen: { latitude: 15.0, longitude: 39.0 },
		},
	},
	Eswatini: {
		latitude: -26.5225,
		longitude: 31.4659,
		subDistricts: {
			Hhohho: { latitude: -26.0, longitude: 31.0 },
			Lubombo: { latitude: -26.0, longitude: 31.0 },
			Manzini: { latitude: -26.0, longitude: 31.0 },
			Shiselweni: { latitude: -26.0, longitude: 31.0 },
		},
	},
	Ethiopia: {
		latitude: 9.145,
		longitude: 40.4897,
		subDistricts: {
			AddisAbaba: { latitude: 9.0, longitude: 38.0 },
			Afar: { latitude: 12.0, longitude: 41.0 },
			Amhara: { latitude: 11.0, longitude: 37.0 },
			BenishangulGumuz: { latitude: 10.0, longitude: 36.0 },
			DireDawa: { latitude: 9.0, longitude: 41.0 },
			Gambela: { latitude: 8.0, longitude: 34.0 },
			Harari: { latitude: 9.0, longitude: 42.0 },
			Oromia: { latitude: 9.0, longitude: 40.0 },
			Sidama: { latitude: 7.0, longitude: 38.0 },
			Somali: { latitude: 8.0, longitude: 44.0 },
			SouthernNations: { latitude: 6.0, longitude: 37.0 },
			Tigray: { latitude: 14.0, longitude: 38.0 },
		},
	},
	Gabon: {
		latitude: -0.8031,
		longitude: 11.6094,
		subDistricts: {
			Estuaire: { latitude: 0.0, longitude: 9.0 },
			HautOgooué: { latitude: -1.0, longitude: 13.0 },
			MoyenOgooué: { latitude: -1.0, longitude: 10.0 },
			Ngounié: { latitude: -1.0, longitude: 10.0 },
			Nyanga: { latitude: -2.0, longitude: 10.0 },
			OgoouéIvindo: { latitude: -1.0, longitude: 12.0 },
			OgoouéLolo: { latitude: -1.0, longitude: 10.0 },
			WoleuNtem: { latitude: 1.0, longitude: 10.0 },
		},
	},
	Gambia: {
		latitude: 13.4662,
		longitude: -15.3875,
		subDistricts: {
			Banjul: { latitude: 13.0, longitude: -16.0 },
			CentralRiver: { latitude: 13.0, longitude: -15.0 },
			LowerRiver: { latitude: 13.0, longitude: -15.0 },
			NorthBank: { latitude: 13.0, longitude: -15.0 },
			UpperRiver: { latitude: 13.0, longitude: -15.0 },
			Western: { latitude: 13.0, longitude: -16.0 },
		},
	},
	Ghana: {
		latitude: 7.1734,
		longitude: -0.096,
		subDistricts: {
			GreaterAccra: { latitude: 5.0, longitude: -0.0 },
			Ashanti: { latitude: 7.0, longitude: -1.0 },
			Western: { latitude: 5.0, longitude: -2.0 },
			Eastern: { latitude: 6.0, longitude: -0.0 },
			Northern: { latitude: 9.0, longitude: -1.0 },
			WesternNorth: { latitude: 6.0, longitude: -2.0 },
			Central: { latitude: 5.0, longitude: -1.0 },
			Bono: { latitude: 7.0, longitude: -1.0 },
			BonoEast: { latitude: 7.0, longitude: -1.0 },
			Oti: { latitude: 8.0, longitude: -0.0 },
			Volta: { latitude: 7.0, longitude: -0.0 },
		},
	},
	Guinea: {
		latitude: 9.9456,
		longitude: -9.6966,
		subDistricts: {
			Boké: { latitude: 10.0, longitude: -14.0 },
			Conakry: { latitude: 10.0, longitude: -14.0 },
			Faranah: { latitude: 10.0, longitude: -10.0 },
			Kankan: { latitude: 10.0, longitude: -9.0 },
			Kindia: { latitude: 10.0, longitude: -12.0 },
			Mamou: { latitude: 10.0, longitude: -12.0 },
			Nzérékoré: { latitude: 8.0, longitude: -9.0 },
		},
	},
	GuineaBissau: {
		latitude: 11.8037,
		longitude: -15.1804,
		subDistricts: {
			Bafatá: { latitude: 12.0, longitude: -14.0 },
			Biombo: { latitude: 11.0, longitude: -15.0 },
			Bolama: { latitude: 11.0, longitude: -15.0 },
			Cacheu: { latitude: 12.0, longitude: -15.0 },
			Gabu: { latitude: 12.0, longitude: -15.0 },
			Oio: { latitude: 12.0, longitude: -15.0 },
			Quinara: { latitude: 11.0, longitude: -15.0 },
			Tombali: { latitude: 11.0, longitude: -15.0 },
		},
	},
	IvoryCoast: {
		latitude: 7.5399,
		longitude: -5.5471,
		subDistricts: {
			Abidjan: { latitude: 5.0, longitude: -4.0 },
			Agnéby: { latitude: 6.0, longitude: -4.0 },
			Bafing: { latitude: 8.0, longitude: -6.0 },
			Bandama: { latitude: 8.0, longitude: -4.0 },
			BasSassandra: { latitude: 6.0, longitude: -5.0 },
			Comoé: { latitude: 8.0, longitude: -3.0 },
			Denguele: { latitude: 9.0, longitude: -6.0 },
			Gôh: { latitude: 6.0, longitude: -5.0 },
			Lacs: { latitude: 7.0, longitude: -4.0 },
			Lagunes: { latitude: 6.0, longitude: -4.0 },
			Montagnes: { latitude: 7.0, longitude: -7.0 },
			Savanes: { latitude: 9.0, longitude: -5.0 },
			ValléeDuBandama: { latitude: 8.0, longitude: -4.0 },
			Yamoussoukro: { latitude: 6.0, longitude: -4.0 },
		},
	},
	Kenya: {
		latitude: -1.2864,
		longitude: 36.8172,
		subDistricts: {
			Bomet: { latitude: -0.0, longitude: 35.0 },
			Bungoma: { latitude: 0.0, longitude: 34.0 },
			Busia: { latitude: 0.0, longitude: 34.0 },
			ElgeyoMarakwet: { latitude: 0.0, longitude: 35.0 },
			Embu: { latitude: -0.0, longitude: 37.0 },
			Garissa: { latitude: 0.0, longitude: 39.0 },
			HomaBay: { latitude: -1.0, longitude: 34.0 },
			Isiolo: { latitude: 0.0, longitude: 37.0 },
			Kajiado: { latitude: -1.0, longitude: 36.0 },
			Kakamega: { latitude: 0.0, longitude: 34.0 },
			Kericho: { latitude: -0.0, longitude: 35.0 },
			Kiambu: { latitude: -1.0, longitude: 36.0 },
			Kilifi: { latitude: -3.0, longitude: 39.0 },
			Kirinyaga: { latitude: -0.0, longitude: 37.0 },
			Kisii: { latitude: -1.0, longitude: 34.0 },
			Kisumu: { latitude: -1.0, longitude: 34.0 },
			Laikipia: { latitude: 0.0, longitude: 37.0 },
			Lamu: { latitude: -2.0, longitude: 40.0 },
			Machakos: { latitude: -1.0, longitude: 37.0 },
			Makueni: { latitude: -1.0, longitude: 37.0 },
			Mandera: { latitude: 0.0, longitude: 41.0 },
			Meru: { latitude: -1.0, longitude: 37.0 },
			Migori: { latitude: -1.0, longitude: 34.0 },
			Nakuru: { latitude: -1.0, longitude: 36.0 },
			Nairobi: { latitude: -1.0, longitude: 36.0 },
			Narok: { latitude: -1.0, longitude: 35.0 },
			Nyandarua: { latitude: -1.0, longitude: 36.0 },
			Nyeri: { latitude: -1.0, longitude: 36.0 },
			Samburu: { latitude: 0.0, longitude: 37.0 },
			Siaya: { latitude: -1.0, longitude: 34.0 },
			TaitaTaveta: { latitude: -3.0, longitude: 38.0 },
			Tanzania: { latitude: -6.0, longitude: 35.0 },
			TharakaNithi: { latitude: -1.0, longitude: 37.0 },
			TransNzoia: { latitude: 0.0, longitude: 34.0 },
			UasinGishu: { latitude: 0.0, longitude: 35.0 },
			Vihiga: { latitude: -1.0, longitude: 34.0 },
			Wajir: { latitude: 0.0, longitude: 40.0 },
			WestPokot: { latitude: 0.0, longitude: 35.0 },
		},
	},
	Lesotho: {
		latitude: -29.6094,
		longitude: 28.2336,
		subDistricts: {
			Berea: { latitude: -29.0, longitude: 28.0 },
			ButhaButhe: { latitude: -29.0, longitude: 28.0 },
			Leribe: { latitude: -29.0, longitude: 28.0 },
			Mafeteng: { latitude: -29.0, longitude: 27.0 },
			Maseru: { latitude: -29.0, longitude: 27.0 },
			Mohale_sHoek: { latitude: -29.0, longitude: 27.0 },
			Qacha_sNeck: { latitude: -29.0, longitude: 27.0 },
			Quthing: { latitude: -29.0, longitude: 27.0 },
			ThabaTseka: { latitude: -29.0, longitude: 27.0 },
		},
	},
	Liberia: {
		latitude: 6.4281,
		longitude: -9.4295,
		subDistricts: {
			Bomi: { latitude: 6.0, longitude: -10.0 },
			Bong: { latitude: 7.0, longitude: -9.0 },
			Gbarpolu: { latitude: 7.0, longitude: -10.0 },
			GrandBassa: { latitude: 6.0, longitude: -9.0 },
			GrandCapeMount: { latitude: 6.0, longitude: -10.0 },
			GrandGedeh: { latitude: 7.0, longitude: -8.0 },
			Lofa: { latitude: 7.0, longitude: -9.0 },
			Margibi: { latitude: 6.0, longitude: -10.0 },
			Maryland: { latitude: 5.0, longitude: -9.0 },
			Montserrado: { latitude: 6.0, longitude: -10.0 },
			Nimba: { latitude: 7.0, longitude: -8.0 },
			RiverCess: { latitude: 6.0, longitude: -9.0 },
			RiverGee: { latitude: 7.0, longitude: -8.0 },
			Sinoe: { latitude: 6.0, longitude: -9.0 },
		},
	},
	Libya: {
		latitude: 26.3351,
		longitude: 17.2283,
		subDistricts: {
			AlJufra: { latitude: 29.0, longitude: 16.0 },
			AlKufrah: { latitude: 24.0, longitude: 18.0 },
			AlMarqab: { latitude: 32.0, longitude: 14.0 },
			AlWahat: { latitude: 25.0, longitude: 20.0 },
			Benghazi: { latitude: 32.0, longitude: 20.0 },
			Derna: { latitude: 32.0, longitude: 22.0 },
			Ghadames: { latitude: 30.0, longitude: 10.0 },
			Ghat: { latitude: 24.0, longitude: 12.0 },
			JabalAlGharbi: { latitude: 32.0, longitude: 12.0 },
			Misrata: { latitude: 32.0, longitude: 15.0 },
			Murzuq: { latitude: 25.0, longitude: 13.0 },
			Nalut: { latitude: 31.0, longitude: 10.0 },
			Sabha: { latitude: 27.0, longitude: 14.0 },
			Sirt: { latitude: 32.0, longitude: 16.0 },
			Tripoli: { latitude: 32.0, longitude: 13.0 },
			WadiAlHayaa: { latitude: 30.0, longitude: 12.0 },
			Zliten: { latitude: 32.0, longitude: 14.0 },
		},
	},
	Madagascar: {
		latitude: -18.7669,
		longitude: 46.8691,
		subDistricts: {
			Antananarivo: { latitude: -18.0, longitude: 47.0 },
			Antsiranana: { latitude: -12.0, longitude: 49.0 },
			Fianarantsoa: { latitude: -21.0, longitude: 47.0 },
			Mahajanga: { latitude: -15.0, longitude: 46.0 },
			Toamasina: { latitude: -18.0, longitude: 49.0 },
			Toliara: { latitude: -23.0, longitude: 43.0 },
		},
	},
	Malawi: {
		latitude: -13.2543,
		longitude: 34.3015,
		subDistricts: {
			Balaka: { latitude: -14.0, longitude: 35.0 },
			Blantyre: { latitude: -15.0, longitude: 35.0 },
			Chikwawa: { latitude: -16.0, longitude: 34.0 },
			Chiradzulu: { latitude: -15.0, longitude: 35.0 },
			Dedza: { latitude: -14.0, longitude: 34.0 },
			Dowa: { latitude: -13.0, longitude: 34.0 },
			Kasungu: { latitude: -13.0, longitude: 34.0 },
			Lilongwe: { latitude: -13.0, longitude: 33.0 },
			Machinga: { latitude: -15.0, longitude: 35.0 },
			Mangochi: { latitude: -14.0, longitude: 35.0 },
			Mulanje: { latitude: -15.0, longitude: 35.0 },
			Mwanza: { latitude: -15.0, longitude: 35.0 },
			Neno: { latitude: -15.0, longitude: 34.0 },
			Nkhotakota: { latitude: -12.0, longitude: 34.0 },
			Nsanje: { latitude: -16.0, longitude: 34.0 },
			Ntcheu: { latitude: -14.0, longitude: 34.0 },
			Ntchisi: { latitude: -13.0, longitude: 34.0 },
			Rumphi: { latitude: -10.0, longitude: 34.0 },
			Salima: { latitude: -13.0, longitude: 34.0 },
			Thyolo: { latitude: -16.0, longitude: 35.0 },
			Zomba: { latitude: -15.0, longitude: 35.0 },
		},
	},
	Mali: {
		latitude: 17.5707,
		longitude: -3.9962,
		subDistricts: {
			Bamako: { latitude: 12.0, longitude: -8.0 },
			Gao: { latitude: 16.0, longitude: -0.0 },
			Kayes: { latitude: 14.0, longitude: -12.0 },
			Koulikoro: { latitude: 12.0, longitude: -8.0 },
			Mopti: { latitude: 14.0, longitude: -4.0 },
			Segou: { latitude: 13.0, longitude: -6.0 },
			Sikasso: { latitude: 11.0, longitude: -5.0 },
			Tombouctou: { latitude: 16.0, longitude: -3.0 },
		},
	},
	Mauritania: {
		latitude: 20.254,
		longitude: -10.9408,
		subDistricts: {
			Adrar: { latitude: 20.0, longitude: -12.0 },
			Assaba: { latitude: 16.0, longitude: -12.0 },
			Brakna: { latitude: 17.0, longitude: -13.0 },
			Gorgol: { latitude: 17.0, longitude: -12.0 },
			Guidimaka: { latitude: 16.0, longitude: -12.0 },
			HodhElGharbi: { latitude: 16.0, longitude: -12.0 },
			HodhChrarghi: { latitude: 16.0, longitude: -12.0 },
			Inchiri: { latitude: 20.0, longitude: -14.0 },
			Nouakchott: { latitude: 18.0, longitude: -15.0 },
			Tagant: { latitude: 20.0, longitude: -12.0 },
			TirisZemmour: { latitude: 20.0, longitude: -12.0 },
		},
	},
	Mauritius: {
		latitude: -20.348404,
		longitude: 57.552152,
		subDistricts: {
			Agalega: { latitude: -10.0, longitude: 56.0 },
			Rodrigues: { latitude: -19.0, longitude: 63.0 },
			Flacq: { latitude: -20.0, longitude: 57.0 },
			GrandPort: { latitude: -20.0, longitude: 57.0 },
			Moka: { latitude: -20.0, longitude: 57.0 },
			Pamplemousses: { latitude: -20.0, longitude: 57.0 },
			PlainesWilhems: { latitude: -20.0, longitude: 57.0 },
			PortLouis: { latitude: -20.0, longitude: 57.0 },
			RivièreDuRempart: { latitude: -20.0, longitude: 57.0 },
			Savanne: { latitude: -20.0, longitude: 57.0 },
		},
	},
	Morocco: {
		latitude: 31.7917,
		longitude: -7.0926,
		subDistricts: {
			Agadir: { latitude: 30.0, longitude: -9.0 },
			Casablanca: { latitude: 33.0, longitude: -7.0 },
			Fes: { latitude: 34.0, longitude: -5.0 },
			Marrakech: { latitude: 31.0, longitude: -8.0 },
			Meknes: { latitude: 33.0, longitude: -5.0 },
			Rabat: { latitude: 34.0, longitude: -6.0 },
			Tangier: { latitude: 35.0, longitude: -5.0 },
			Taza: { latitude: 34.0, longitude: -4.0 },
		},
	},
	Mozambique: {
		latitude: -18.6657,
		longitude: 35.5299,
		subDistricts: {
			CaboDelgado: { latitude: -10.0, longitude: 40.0 },
			Gaza: { latitude: -25.0, longitude: 33.0 },
			Inhambane: { latitude: -23.0, longitude: 35.0 },
			Manica: { latitude: -19.0, longitude: 33.0 },
			Maputo: { latitude: -25.0, longitude: 32.0 },
			Nampula: { latitude: -15.0, longitude: 39.0 },
			Niassa: { latitude: -12.0, longitude: 37.0 },
			Sofala: { latitude: -19.0, longitude: 34.0 },
			Tete: { latitude: -16.0, longitude: 33.0 },
			Zambezia: { latitude: -16.0, longitude: 36.0 },
		},
	},
	Namibia: {
		latitude: -22.9576,
		longitude: 18.4904,
		subDistricts: {
			Erongo: { latitude: -22.0, longitude: 14.0 },
			Hardap: { latitude: -24.0, longitude: 17.0 },
			Karas: { latitude: -27.0, longitude: 18.0 },
			KavangoEast: { latitude: -18.0, longitude: 20.0 },
			KavangoWest: { latitude: -18.0, longitude: 20.0 },
			Khomas: { latitude: -22.0, longitude: 17.0 },
			Kunene: { latitude: -20.0, longitude: 14.0 },
			Ohangwena: { latitude: -17.0, longitude: 15.0 },
			Omusati: { latitude: -17.0, longitude: 14.0 },
			Oshana: { latitude: -17.0, longitude: 15.0 },
			Oshikoto: { latitude: -17.0, longitude: 16.0 },
			Zambezi: { latitude: -17.0, longitude: 25.0 },
		},
	},
	Niger: {
		latitude: 17.6078,
		longitude: 8.0817,
		subDistricts: {
			Agadez: { latitude: 16.0, longitude: 8.0 },
			Diffa: { latitude: 13.0, longitude: 12.0 },
			Dosso: { latitude: 13.0, longitude: 6.0 },
			Maradi: { latitude: 14.0, longitude: 7.0 },
			Niamey: { latitude: 13.0, longitude: 2.0 },
			Tahoua: { latitude: 15.0, longitude: 6.0 },
			Tillabéri: { latitude: 15.0, longitude: 5.0 },
			Zinder: { latitude: 14.0, longitude: 8.0 },
		},
	},
	Nigeria: {
		latitude: 9.082,
		longitude: 8.6753,
		subDistricts: {
			Abia: { latitude: 5.0, longitude: 7.0 },
			Adamawa: { latitude: 9.0, longitude: 12.0 },
			AkwaIbom: { latitude: 5.0, longitude: 8.0 },
			Anambra: { latitude: 6.0, longitude: 7.0 },
			Bauchi: { latitude: 10.0, longitude: 9.0 },
			Bayelsa: { latitude: 5.0, longitude: 6.0 },
			Benue: { latitude: 7.0, longitude: 9.0 },
			Borno: { latitude: 11.0, longitude: 13.0 },
			CrossRiver: { latitude: 5.0, longitude: 8.0 },
			Delta: { latitude: 6.0, longitude: 6.0 },
			Ebonyi: { latitude: 6.0, longitude: 8.0 },
			Edo: { latitude: 6.0, longitude: 6.0 },
			Ekiti: { latitude: 7.0, longitude: 5.0 },
			Enugu: { latitude: 6.0, longitude: 7.0 },
			Gombe: { latitude: 10.0, longitude: 11.0 },
			Imo: { latitude: 5.0, longitude: 7.0 },
			Jigawa: { latitude: 11.0, longitude: 9.0 },
			Kaduna: { latitude: 10.0, longitude: 7.0 },
			Kano: { latitude: 12.0, longitude: 8.0 },
			Katsina: { latitude: 12.0, longitude: 7.0 },
			Kebbi: { latitude: 12.0, longitude: 4.0 },
			Kogi: { latitude: 7.0, longitude: 6.0 },
			Kwara: { latitude: 8.0, longitude: 5.0 },
			Lagos: { latitude: 6.0, longitude: 3.0 },
			Nasarawa: { latitude: 8.0, longitude: 8.0 },
			Niger: { latitude: 9.0, longitude: 6.0 },
			Ogun: { latitude: 7.0, longitude: 4.0 },
			Ondo: { latitude: 7.0, longitude: 5.0 },
			Osun: { latitude: 7.0, longitude: 4.0 },
			Oyo: { latitude: 7.0, longitude: 4.0 },
			Plateau: { latitude: 9.0, longitude: 9.0 },
			Rivers: { latitude: 5.0, longitude: 6.0 },
			Sokoto: { latitude: 13.0, longitude: 5.0 },
			Taraba: { latitude: 8.0, longitude: 10.0 },
			Yobe: { latitude: 11.0, longitude: 12.0 },
			Zamfara: { latitude: 12.0, longitude: 6.0 },
		},
	},
	Rwanda: {
		latitude: -1.9403,
		longitude: 29.8739,
		subDistricts: {
			Eastern: { latitude: -2.0, longitude: 30.0 },
			Northern: { latitude: -1.0, longitude: 30.0 },
			Southern: { latitude: -2.0, longitude: 29.0 },
			Western: { latitude: -1.0, longitude: 29.0 },
			Kigali: { latitude: -1.0, longitude: 29.0 },
		},
	},
	SaoTomeandPrincipe: {
		latitude: 0.334,
		longitude: 6.7323,
		subDistricts: {
			ÁguaGrande: { latitude: 0.0, longitude: 7.0 },
			Cantagalo: { latitude: 0.0, longitude: 7.0 },
			Lembá: { latitude: 0.0, longitude: 7.0 },
			Mé_Zóchi: { latitude: 0.0, longitude: 7.0 },
			Pagué: { latitude: 0.0, longitude: 7.0 },
			Principe: { latitude: 1.0, longitude: 6.0 },
		},
	},
	Senegal: {
		latitude: 14.4974,
		longitude: -14.4524,
		subDistricts: {
			Dakar: { latitude: 14.0, longitude: -17.0 },
			Diourbel: { latitude: 14.0, longitude: -15.0 },
			Fatick: { latitude: 14.0, longitude: -15.0 },
			Kaolack: { latitude: 14.0, longitude: -15.0 },
			Kolda: { latitude: 12.0, longitude: -14.0 },
			Louga: { latitude: 15.0, longitude: -15.0 },
			Matam: { latitude: 15.0, longitude: -14.0 },
			SaintLouis: { latitude: 16.0, longitude: -16.0 },
			Tambacounda: { latitude: 13.0, longitude: -14.0 },
			Thies: { latitude: 14.0, longitude: -15.0 },
			Ziguinchor: { latitude: 12.0, longitude: -16.0 },
		},
	},
	Seychelles: {
		latitude: -4.6796,
		longitude: 55.4915,
		subDistricts: {
			AnseBoileau: { latitude: -4.0, longitude: 55.0 },
			AnseLouis: { latitude: -4.0, longitude: 55.0 },
			AnseTakamaka: { latitude: -4.0, longitude: 55.0 },
			BaieSainteAnne: { latitude: -4.0, longitude: 55.0 },
			BeauVallon: { latitude: -4.0, longitude: 55.0 },
			BelAir: { latitude: -4.0, longitude: 55.0 },
			Belombre: { latitude: -4.0, longitude: 55.0 },
			Cascade: { latitude: -4.0, longitude: 55.0 },
			Glacis: { latitude: -4.0, longitude: 55.0 },
			LaDigue: { latitude: -4.0, longitude: 55.0 },
			MontFleuri: { latitude: -4.0, longitude: 55.0 },
			PointeLarue: { latitude: -4.0, longitude: 55.0 },
			Praslin: { latitude: -4.0, longitude: 55.0 },
			RocheCaiman: { latitude: -4.0, longitude: 55.0 },
			SaintLouis: { latitude: -4.0, longitude: 55.0 },
			Takamaka: { latitude: -4.0, longitude: 55.0 },
		},
	},
	SierraLeone: {
		latitude: 8.4606,
		longitude: -11.7799,
		subDistricts: {
			Bombali: { latitude: 9.0, longitude: -12.0 },
			Bo: { latitude: 7.0, longitude: -12.0 },
			Bonthe: { latitude: 7.0, longitude: -12.0 },
			Kailahun: { latitude: 8.0, longitude: -11.0 },
			Kambia: { latitude: 9.0, longitude: -12.0 },
			Kenema: { latitude: 7.0, longitude: -11.0 },
			Koinadugu: { latitude: 9.0, longitude: -12.0 },
			PortLoko: { latitude: 8.0, longitude: -12.0 },
			Pujehun: { latitude: 7.0, longitude: -12.0 },
			Tonkolili: { latitude: 8.0, longitude: -12.0 },
			WesternArea: { latitude: 8.0, longitude: -12.0 },
		},
	},
	Somalia: {
		latitude: 5.1521,
		longitude: 46.1996,
		subDistricts: {
			Awdal: { latitude: 10.0, longitude: 43.0 },
			Bakool: { latitude: 4.0, longitude: 45.0 },
			Banaadir: { latitude: 2.0, longitude: 45.0 },
			Bari: { latitude: 10.0, longitude: 49.0 },
			Bay: { latitude: 4.0, longitude: 46.0 },
			Galguduud: { latitude: 5.0, longitude: 46.0 },
			Gedo: { latitude: 4.0, longitude: 42.0 },
			Hiiraan: { latitude: 3.0, longitude: 45.0 },
			JubbadaHoose: { latitude: 2.0, longitude: 42.0 },
			JubbadaSaxeex: { latitude: 2.0, longitude: 42.0 },
			Mudug: { latitude: 5.0, longitude: 46.0 },
			Nugaal: { latitude: 7.0, longitude: 47.0 },
			Sanaag: { latitude: 9.0, longitude: 47.0 },
			Sool: { latitude: 8.0, longitude: 47.0 },
			Togdheer: { latitude: 9.0, longitude: 45.0 },
			WoqooyiGalbeed: { latitude: 10.0, longitude: 45.0 },
		},
	},
	SouthAfrica: {
		latitude: -30.5595,
		longitude: 22.9375,
		subDistricts: {
			EasternCape: { latitude: -30.0, longitude: 26.0 },
			FreeState: { latitude: -28.0, longitude: 26.0 },
			Gauteng: { latitude: -26.0, longitude: 28.0 },
			KwaZuluNatal: { latitude: -29.0, longitude: 31.0 },
			Limpopo: { latitude: -23.0, longitude: 30.0 },
			Mpumalanga: { latitude: -25.0, longitude: 30.0 },
			NorthernCape: { latitude: -29.0, longitude: 22.0 },
			NorthWest: { latitude: -25.0, longitude: 25.0 },
			WesternCape: { latitude: -33.0, longitude: 18.0 },
		},
	},
	SouthSudan: {
		latitude: 6.876,
		longitude: 31.3069,
		subDistricts: {
			CentralEquatoria: { latitude: 5.0, longitude: 30.0 },
			EasternEquatoria: { latitude: 5.0, longitude: 32.0 },
			Jonglei: { latitude: 7.0, longitude: 32.0 },
			Lakes: { latitude: 6.0, longitude: 30.0 },
			NorthernBahrElGhazal: { latitude: 8.0, longitude: 27.0 },
			Unity: { latitude: 7.0, longitude: 30.0 },
			UpperNile: { latitude: 9.0, longitude: 31.0 },
			Warrap: { latitude: 7.0, longitude: 28.0 },
			WesternBahrElGhazal: { latitude: 7.0, longitude: 25.0 },
		},
	},
	Sudan: {
		latitude: 12.8628,
		longitude: 30.2176,
		subDistricts: {
			AlBahrAlAhmar: { latitude: 20.0, longitude: 30.0 },
			AlJazirah: { latitude: 14.0, longitude: 33.0 },
			AlQadarif: { latitude: 14.0, longitude: 36.0 },
			AlWahda: { latitude: 10.0, longitude: 30.0 },
			BlueNile: { latitude: 10.0, longitude: 34.0 },
			Darfur: { latitude: 13.0, longitude: 25.0 },
			Khartoum: { latitude: 15.0, longitude: 32.0 },
			Northern: { latitude: 20.0, longitude: 30.0 },
			RiverNile: { latitude: 18.0, longitude: 31.0 },
			Sennar: { latitude: 13.0, longitude: 34.0 },
			SouthDarfur: { latitude: 13.0, longitude: 25.0 },
			WestDarfur: { latitude: 13.0, longitude: 25.0 },
		},
	},
	Tanzania: {
		latitude: -6.3693,
		longitude: 34.8888,
		subDistricts: {
			Arusha: { latitude: -4.0, longitude: 36.0 },
			DarEsSalaam: { latitude: -6.0, longitude: 39.0 },
			Dodoma: { latitude: -6.0, longitude: 35.0 },
			Iringa: { latitude: -7.0, longitude: 35.0 },
			Kagera: { latitude: -2.0, longitude: 31.0 },
			Katavi: { latitude: -7.0, longitude: 31.0 },
			Kigoma: { latitude: -4.0, longitude: 29.0 },
			Kilimanjaro: { latitude: -3.0, longitude: 37.0 },
			Lindi: { latitude: -10.0, longitude: 39.0 },
			Manyara: { latitude: -4.0, longitude: 35.0 },
			Mara: { latitude: -2.0, longitude: 34.0 },
			Mbeya: { latitude: -8.0, longitude: 33.0 },
			Morogoro: { latitude: -7.0, longitude: 37.0 },
			Mtwara: { latitude: -10.0, longitude: 40.0 },
			Njombe: { latitude: -9.0, longitude: 34.0 },
			Pwani: { latitude: -6.0, longitude: 38.0 },
			Rukwa: { latitude: -8.0, longitude: 31.0 },
			Ruvuma: { latitude: -10.0, longitude: 35.0 },
			Shinyanga: { latitude: -3.0, longitude: 33.0 },
			Simiyu: { latitude: -3.0, longitude: 34.0 },
			Singida: { latitude: -5.0, longitude: 34.0 },
			Tabora: { latitude: -6.0, longitude: 33.0 },
			Tanga: { latitude: -5.0, longitude: 38.0 },
		},
	},
	Togo: {
		latitude: 8.6195,
		longitude: 0.8248,
		subDistricts: {
			Centrale: { latitude: 8.0, longitude: 1.0 },
			Kara: { latitude: 9.0, longitude: 1.0 },
			Maritime: { latitude: 6.0, longitude: 1.0 },
			Plateaux: { latitude: 8.0, longitude: 1.0 },
			Savanes: { latitude: 10.0, longitude: 1.0 },
		},
	},
	Tunisia: {
		latitude: 33.8869,
		longitude: 9.5375,
		subDistricts: {
			Ariana: { latitude: 36.0, longitude: 10.0 },
			Béja: { latitude: 36.0, longitude: 9.0 },
			BenArous: { latitude: 36.0, longitude: 10.0 },
			Bizerte: { latitude: 37.0, longitude: 9.0 },
			Gabès: { latitude: 33.0, longitude: 10.0 },
			Gafsa: { latitude: 34.0, longitude: 8.0 },
			Jendouba: { latitude: 36.0, longitude: 8.0 },
			Kairouan: { latitude: 35.0, longitude: 10.0 },
			Kasserine: { latitude: 35.0, longitude: 8.0 },
			Kebili: { latitude: 33.0, longitude: 8.0 },
			Manouba: { latitude: 36.0, longitude: 10.0 },
			Medenine: { latitude: 33.0, longitude: 10.0 },
			Monastir: { latitude: 35.0, longitude: 10.0 },
			Nabeul: { latitude: 36.0, longitude: 10.0 },
			Sfax: { latitude: 34.0, longitude: 10.0 },
			Sousse: { latitude: 35.0, longitude: 10.0 },
			Tataouine: { latitude: 33.0, longitude: 10.0 },
			Tozeur: { latitude: 33.0, longitude: 8.0 },
			Zaghouan: { latitude: 36.0, longitude: 10.0 },
		},
	},
	Uganda: {
		latitude: 1.3733,
		longitude: 32.2903,
		subDistricts: {
			Adjumani: { latitude: 4.0, longitude: 31.0 },
			Apac: { latitude: 1.0, longitude: 32.0 },
			Arua: { latitude: 3.0, longitude: 30.0 },
			Bugiri: { latitude: 0.0, longitude: 33.0 },
			Bukedea: { latitude: 1.0, longitude: 34.0 },
			Bundibugyo: { latitude: 0.0, longitude: 30.0 },
			Bushenyi: { latitude: -0.0, longitude: 30.0 },
			Gulu: { latitude: 2.0, longitude: 32.0 },
			Hoima: { latitude: 1.0, longitude: 31.0 },
			Iganga: { latitude: 0.0, longitude: 33.0 },
			Jinja: { latitude: 0.0, longitude: 33.0 },
			Kabale: { latitude: -1.0, longitude: 29.0 },
			Kabarole: { latitude: 0.0, longitude: 30.0 },
			Kamuli: { latitude: 0.0, longitude: 33.0 },
			Kanungu: { latitude: -1.0, longitude: 29.0 },
			Kapchorwa: { latitude: 1.0, longitude: 34.0 },
			Kasese: { latitude: 0.0, longitude: 30.0 },
			Katakwi: { latitude: 1.0, longitude: 34.0 },
			Kayunga: { latitude: 0.0, longitude: 33.0 },
			Kiboga: { latitude: 1.0, longitude: 31.0 },
			Kisoro: { latitude: -1.0, longitude: 29.0 },
			Kitgum: { latitude: 3.0, longitude: 32.0 },
			Koboko: { latitude: 4.0, longitude: 30.0 },
			Kumi: { latitude: 1.0, longitude: 34.0 },
			Lira: { latitude: 2.0, longitude: 32.0 },
			Masaka: { latitude: -0.0, longitude: 31.0 },
			Masindi: { latitude: 1.0, longitude: 31.0 },
			Mbarara: { latitude: -0.0, longitude: 30.0 },
			Mbale: { latitude: 1.0, longitude: 34.0 },
			Mityana: { latitude: 0.0, longitude: 31.0 },
			Mukono: { latitude: 0.0, longitude: 33.0 },
			Nakaseke: { latitude: 1.0, longitude: 31.0 },
			Nakasongola: { latitude: 1.0, longitude: 32.0 },
			Nebbi: { latitude: 3.0, longitude: 30.0 },
			Ntungamo: { latitude: -0.0, longitude: 30.0 },
			Oyam: { latitude: 2.0, longitude: 32.0 },
			Rukungiri: { latitude: -0.0, longitude: 29.0 },
			Sembabule: { latitude: -0.0, longitude: 31.0 },
			Soroti: { latitude: 1.0, longitude: 33.0 },
			Tororo: { latitude: 0.0, longitude: 34.0 },
			Wakiso: { latitude: 0.0, longitude: 32.0 },
			Yumbe: { latitude: 4.0, longitude: 30.0 },
		},
	},
	Zambia: {
		latitude: -13.1339,
		longitude: 27.8493,
		subDistricts: {
			Central: { latitude: -13.0, longitude: 28.0 },
			Copperbelt: { latitude: -12.0, longitude: 28.0 },
			Eastern: { latitude: -12.0, longitude: 30.0 },
			Luapula: { latitude: -9.0, longitude: 28.0 },
			Lusaka: { latitude: -15.0, longitude: 28.0 },
			Northern: { latitude: -10.0, longitude: 28.0 },
			NorthWestern: { latitude: -12.0, longitude: 25.0 },
			Southern: { latitude: -15.0, longitude: 27.0 },
			Western: { latitude: -15.0, longitude: 23.0 },
		},
	},
	...
	Australia: {
		...
		subDistricts: {
			...
			Queensland: { latitude: -27.0, longitude: 139.0 },
			SouthAustralia: { latitude: -30.0, longitude: 135.0 },
			Tasmania: { latitude: -42.0, longitude: 147.0 },
			Victoria: { latitude: -37.0, longitude: 144.0 },
			WesternAustralia: { latitude: -25.0, longitude: 115.0 },
	...
	Fiji: {
		...
		longitude: 178.065,
		subDistricts: {
			Ba: { latitude: -17.0, longitude: 177.0 },
			Bua: { latitude: -16.0, longitude: 178.0 },
			Cakaudrove: { latitude: -16.0, longitude: 179.0 },
			Kadavu: { latitude: -20.0, longitude: 178.0 },
			Lau: { latitude: -19.0, longitude: 178.0 },
			Lomaiviti: { latitude: -18.0, longitude: 178.0 },
			Macuata: { latitude: -16.0, longitude: 178.0 },
			Nadroga_Navosa: { latitude: -18.0, longitude: 177.0 },
			Naitasiri: { latitude: -18.0, longitude: 178.0 },
			Namosi: { latitude: -18.0, longitude: 178.0 },
			Ra: { latitude: -17.0, longitude: 178.0 },
			Rewa: { latitude: -18.0, longitude: 178.0 },
			Serua: { latitude: -18.0, longitude: 178.0 },
			Tailevu: { latitude: -18.0, longitude: 178.0 },
			WesternDivision: { latitude: -17.0, longitude: 177.0 },
		},
	},
	Kiribati: {
		latitude: -3.3704,
		longitude: -168.734,
		subDistricts: {
			GilbertIslands: { latitude: -3.0, longitude: 172.0 },
			LineIslands: { latitude: -2.0, longitude: -157.0 },
			PhoenixIslands: { latitude: -3.0, longitude: -170.0 },
		},
	},
	MarshallIslands: {
		latitude: 7.1095,
		longitude: 171.185,
		subDistricts: {
			Ailinglaplap: { latitude: 7.0, longitude: 169.0 },
			Ailuk: { latitude: 7.0, longitude: 169.0 },
			Arno: { latitude: 7.0, longitude: 168.0 },
			Aur: { latitude: 7.0, longitude: 168.0 },
			Ebon: { latitude: 7.0, longitude: 168.0 },
			Enewetak: { latitude: 7.0, longitude: 168.0 },
			Jaluit: { latitude: 7.0, longitude: 168.0 },
			Kwajalein: { latitude: 7.0, longitude: 168.0 },
			Lae: { latitude: 7.0, longitude: 168.0 },
			Majuro: { latitude: 7.0, longitude: 171.0 },
			Maloelap: { latitude: 7.0, longitude: 169.0 },
			Mili: { latitude: 7.0, longitude: 169.0 },
			Namorik: { latitude: 7.0, longitude: 169.0 },
			Namu: { latitude: 7.0, longitude: 169.0 },
			Rongelap: { latitude: 7.0, longitude: 168.0 },
			Utirik: { latitude: 7.0, longitude: 169.0 },
		},
	},
	Micronesia: {
		latitude: 7.4256,
		longitude: 150.5508,
		subDistricts: {
			Chuuk: { latitude: 7.0, longitude: 151.0 },
			Kosrae: { latitude: 5.0, longitude: 162.0 },
			Pohnpei: { latitude: 6.0, longitude: 158.0 },
			Yap: { latitude: 9.0, longitude: 138.0 },
		},
	},
	Nauru: {
		latitude: -0.5228,
		longitude: 166.9315,
		subDistricts: {
			Aiwo: { latitude: -0.0, longitude: 166.0 },
			Anabar: { latitude: -0.0, longitude: 166.0 },
			Anetan: { latitude: -0.0, longitude: 166.0 },
			Baiti: { latitude: -0.0, longitude: 166.0 },
			Boe: { latitude: -0.0, longitude: 166.0 },
			Buada: { latitude: -0.0, longitude: 166.0 },
			Denigomodu: { latitude: -0.0, longitude: 166.0 },
			Ewa: { latitude: -0.0, longitude: 166.0 },
			Ijuw: { latitude: -0.0, longitude: 166.0 },
			Nauru: { latitude: -0.0, longitude: 166.0 },
			Nibok: { latitude: -0.0, longitude: 166.0 },
			Yaren: { latitude: -0.0, longitude: 166.0 },
		},
	},
	NewZealand: {
		latitude: -40.9006,
		...
		subDistricts: {
			...
			BayOfPlenty: { latitude: -37.0, longitude: 176.0 },
			Canterbury: { latitude: -43.0, longitude: 172.0 },
			Gisborne: { latitude: -38.0, longitude: 178.0 },
			Hawke_sBay: { latitude: -39.0, longitude: 176.0 },
			Manawatu_Wanganui: { latitude: -40.0, longitude: 175.0 },
			Marlborough: { latitude: -41.0, longitude: 173.0 },
			Nelson: { latitude: -41.0, longitude: 173.0 },
			Northland: { latitude: -35.0, longitude: 174.0 },
			Otago: { latitude: -45.0, longitude: 170.0 },
			Southland: { latitude: -46.0, longitude: 168.0 },
			Taranaki: { latitude: -39.0, longitude: 174.0 },
			Wellington: { latitude: -41.0, longitude: 175.0 },
		},
	},
	PapuaNewGuinea: {
		latitude: -6.3149,
		longitude: 143.9555,
		subDistricts: {
			Central: { latitude: -10.0, longitude: 149.0 },
			Chimbu: { latitude: -6.0, longitude: 144.0 },
			EasternHighlands: { latitude: -6.0, longitude: 145.0 },
			Enga: { latitude: -6.0, longitude: 143.0 },
			Gulf: { latitude: -7.0, longitude: 146.0 },
			Madang: { latitude: -5.0, longitude: 145.0 },
			Manus: { latitude: -2.0, longitude: 147.0 },
			MilneBay: { latitude: -10.0, longitude: 150.0 },
			Morobe: { latitude: -6.0, longitude: 146.0 },
			NewIreland: { latitude: -3.0, longitude: 152.0 },
			Oro: { latitude: -8.0, longitude: 148.0 },
			Sandaun: { latitude: -4.0, longitude: 141.0 },
			WestNewBritain: { latitude: -5.0, longitude: 151.0 },
			WestSepik: { latitude: -4.0, longitude: 141.0 },
			Western: { latitude: -6.0, longitude: 143.0 },
		},
	},
	Samoa: {
		latitude: -13.759,
		longitude: -172.1046,
		subDistricts: {
			AigaIleTai: { latitude: -13.0, longitude: -172.0 },
			Atua: { latitude: -13.0, longitude: -172.0 },
			Faasaleleaga: { latitude: -13.0, longitude: -172.0 },
			Gagaifomauga: { latitude: -13.0, longitude: -172.0 },
			Gagaifomauga: { latitude: -13.0, longitude: -172.0 },
			Palauli: { latitude: -13.0, longitude: -172.0 },
			Safata: { latitude: -13.0, longitude: -172.0 },
			Tuamasaga: { latitude: -13.0, longitude: -172.0 },
			Vaimauga: { latitude: -13.0, longitude: -172.0 },
		},
	},
	SolomonIslands: {
		latitude: -9.6457,
		longitude: 160.0248,
		subDistricts: {
			Central: { latitude: -9.0, longitude: 160.0 },
			Choiseul: { latitude: -7.0, longitude: 156.0 },
			Guadalcanal: { latitude: -9.0, longitude: 160.0 },
			Isabel: { latitude: -8.0, longitude: 157.0 },
			Makira: { latitude: -10.0, longitude: 162.0 },
			Malaita: { latitude: -9.0, longitude: 160.0 },
			RennellBellona: { latitude: -10.0, longitude: 160.0 },
			Temotu: { latitude: -10.0, longitude: 165.0 },
			Western: { latitude: -8.0, longitude: 157.0 },
		},
	},
	Tonga: {
		latitude: -21.1789,
		longitude: -175.1982,
		subDistricts: {
			Ha_apai: { latitude: -20.0, longitude: -175.0 },
			Niuas: { latitude: -15.0, longitude: -175.0 },
			Tongatapu: { latitude: -21.0, longitude: -175.0 },
			Vava_u: { latitude: -18.0, longitude: -175.0 },
		},
	},
	Tuvalu: {
		latitude: -7.1095,
		longitude: 179.194,
		subDistricts: {
			Funafuti: { latitude: -7.0, longitude: 179.0 },
			Nanumanga: { latitude: -7.0, longitude: 179.0 },
			Nanumea: { latitude: -7.0, longitude: 179.0 },
			Niutao: { latitude: -7.0, longitude: 179.0 },
			Nui: { latitude: -7.0, longitude: 179.0 },
			Vaitupu: { latitude: -7.0, longitude: 179.0 },
		},
	},
	Vanuatu: {
		latitude: -15.3763,
		longitude: 166.9591,
		subDistricts: {
			Malampa: { latitude: -15.0, longitude: 167.0 },
			Penama: { latitude: -15.0, longitude: 167.0 },
			Sanma: { latitude: -15.0, longitude: 167.0 },
			Shefa: { latitude: -15.0, longitude: 167.0 },
			Tafea: { latitude: -15.0, longitude: 167.0 },
			Torba: { latitude: -15.0, longitude: 167.0 },
		},
	},
	// ... existing countries ...
	...
	Canada: {
		...
		longitude: -106.3468,
		subDistricts: {
			Alberta: { latitude: 53.7267, longitude: -116.0 },
			...
			NovaScotia: { latitude: 44.682, longitude: -63.7443 },
	...
	Mexico: {
		...
		subDistricts: {
			...
			BajaCalifornia: { latitude: 30.0, longitude: -115.0 },
			BajaCaliforniaSur: { latitude: 24.0, longitude: -110.0 },
			Campeche: { latitude: 19.0, longitude: -90.0 },
			Chiapas: { latitude: 16.0, longitude: -92.0 },
			Chihuahua: { latitude: 28.0, longitude: -106.0 },
			Coahuila: { latitude: 27.0, longitude: -102.0 },
			Colima: { latitude: 19.0, longitude: -103.0 },
			Durango: { latitude: 24.0, longitude: -104.0 },
			Guanajuato: { latitude: 21.0, longitude: -101.0 },
			Guerrero: { latitude: 17.0, longitude: -99.0 },
			Hidalgo: { latitude: 20.0, longitude: -98.0 },
			Jalisco: { latitude: 20.0, longitude: -103.0 },
			MexicoState: { latitude: 19.0, longitude: -99.0 },
			Michoacán: { latitude: 19.0, longitude: -102.0 },
			Morelos: { latitude: 18.0, longitude: -99.0 },
			Nayarit: { latitude: 22.0, longitude: -104.0 },
			NuevoLeón: { latitude: 25.0, longitude: -100.0 },
			Oaxaca: { latitude: 17.0, longitude: -96.0 },
			Puebla: { latitude: 19.0, longitude: -98.0 },
			Querétaro: { latitude: 20.0, longitude: -100.0 },
			QuintanaRoo: { latitude: 21.0, longitude: -87.0 },
			SanLuisPotosí: { latitude: 22.0, longitude: -100.0 },
			Sinaloa: { latitude: 25.0, longitude: -107.0 },
			Sonora: { latitude: 30.0, longitude: -110.0 },
			Tabasco: { latitude: 17.0, longitude: -93.0 },
			Tamaulipas: { latitude: 23.0, longitude: -99.0 },
			Tlaxcala: { latitude: 19.0, longitude: -98.0 },
			Veracruz: { latitude: 19.0, longitude: -96.0 },
			Yucatán: { latitude: 21.0, longitude: -89.0 },
			Zacatecas: { latitude: 23.0, longitude: -102.0 },
		},
	},
	Guatemala: {
		latitude: 15.7835,
		longitude: -90.2308,
		subDistricts: {
			AltaVerapaz: { latitude: 15.0, longitude: -90.0 },
			BajaVerapaz: { latitude: 15.0, longitude: -89.0 },
			Chimaltenango: { latitude: 14.0, longitude: -90.0 },
			Chiquimula: { latitude: 14.0, longitude: -89.0 },
			Escuintla: { latitude: 14.0, longitude: -90.0 },
			Guatemala: { latitude: 14.0, longitude: -90.0 },
			Huehuetenango: { latitude: 15.0, longitude: -91.0 },
			Izabal: { latitude: 15.0, longitude: -88.0 },
			Jalapa: { latitude: 14.0, longitude: -89.0 },
			Jutiapa: { latitude: 14.0, longitude: -89.0 },
			Petén: { latitude: 16.0, longitude: -89.0 },
			Quetzaltenango: { latitude: 14.0, longitude: -91.0 },
			Quiché: { latitude: 15.0, longitude: -91.0 },
			Retalhuleu: { latitude: 14.0, longitude: -91.0 },
			Sacatepéquez: { latitude: 14.0, longitude: -90.0 },
			SanMarcos: { latitude: 14.0, longitude: -92.0 },
			SantaRosa: { latitude: 14.0, longitude: -90.0 },
			Solalá: { latitude: 14.0, longitude: -91.0 },
			Suchitepéquez: { latitude: 14.0, longitude: -91.0 },
			Totonicapán: { latitude: 14.0, longitude: -91.0 },
			Zacapa: { latitude: 14.0, longitude: -89.0 },
		},
	},
	Honduras: {
		latitude: 13.4949,
		longitude: -70.1627,
		subDistricts: {
			Atlántida: { latitude: 15.0, longitude: -87.0 },
			Choluteca: { latitude: 13.0, longitude: -83.0 },
			Colón: { latitude: 15.0, longitude: -83.0 },
			Comayagua: { latitude: 14.0, longitude: -87.0 },
			Cortés: { latitude: 15.0, longitude: -88.0 },
			ElParaíso: { latitude: 14.0, longitude: -83.0 },
			FranciscoMorazán: { latitude: 14.0, longitude: -87.0 },
			GraciasADios: { latitude: 15.0, longitude: -83.0 },
			Intibucá: { latitude: 14.0, longitude: -88.0 },
			IslasDeLaBahía: { latitude: 16.0, longitude: -86.0 },
			LaPaz: { latitude: 14.0, longitude: -88.0 },
			Lempira: { latitude: 14.0, longitude: -88.0 },
			Ocotepeque: { latitude: 14.0, longitude: -89.0 },
			Olancho: { latitude: 14.0, longitude: -85.0 },
			SantaBarbara: { latitude: 14.0, longitude: -88.0 },
			Valle: { latitude: 13.0, longitude: -87.0 },
			Yoro: { latitude: 15.0, longitude: -87.0 },
		},
	},
	Nicaragua: {
		latitude: 12.8654,
		longitude: -85.2072,
		subDistricts: {
			Boaco: { latitude: 12.0, longitude: -85.0 },
			Carazo: { latitude: 12.0, longitude: -86.0 },
			Chinandega: { latitude: 13.0, longitude: -87.0 },
			Chontales: { latitude: 12.0, longitude: -84.0 },
			Estelí: { latitude: 13.0, longitude: -86.0 },
			Granada: { latitude: 11.0, longitude: -85.0 },
			Jinotega: { latitude: 13.0, longitude: -85.0 },
			León: { latitude: 12.0, longitude: -86.0 },
			Madriz: { latitude: 13.0, longitude: -86.0 },
			Managua: { latitude: 12.0, longitude: -86.0 },
			Masaya: { latitude: 11.0, longitude: -86.0 },
			Matagalpa: { latitude: 13.0, longitude: -85.0 },
			NuevaSegovia: { latitude: 13.0, longitude: -86.0 },
			Rivas: { latitude: 11.0, longitude: -85.0 },
		},
	},
	CostaRica: {
		latitude: 9.7489,
		longitude: -83.7534,
		subDistricts: {
			Alajuela: { latitude: 10.0, longitude: -84.0 },
			Cartago: { latitude: 9.0, longitude: -83.0 },
			Guanacaste: { latitude: 10.0, longitude: -85.0 },
			Heredia: { latitude: 10.0, longitude: -84.0 },
			Limón: { latitude: 10.0, longitude: -83.0 },
			Puntarenas: { latitude: 9.0, longitude: -84.0 },
			SanJosé: { latitude: 9.0, longitude: -84.0 },
		},
	},
	Panama: {
		latitude: 8.9824,
		longitude: -79.5199,
		subDistricts: {
			BocasDelToro: { latitude: 9.0, longitude: -82.0 },
			Chiriquí: { latitude: 8.0, longitude: -82.0 },
			Coclé: { latitude: 8.0, longitude: -80.0 },
			Colón: { latitude: 9.0, longitude: -79.0 },
			Darién: { latitude: 7.0, longitude: -77.0 },
			Herrera: { latitude: 7.0, longitude: -80.0 },
			LosSantos: { latitude: 7.0, longitude: -80.0 },
			Panamá: { latitude: 8.0, longitude: -79.0 },
			Veraguas: { latitude: 8.0, longitude: -80.0 },
		},
	},
	...
	Argentina: {
		...
		subDistricts: {
			...
			Catamarca: { latitude: -28.469, longitude: -65.785 },
			Chaco: { latitude: -26.0, longitude: -60.0 },
			Chubut: { latitude: -43.0, longitude: -66.0 },
			Córdoba: { latitude: -31.4201, longitude: -64.1888 },
			Corrientes: { latitude: -27.0, longitude: -58.0 },
			EntreRíos: { latitude: -32.0, longitude: -60.0 },
			Formosa: { latitude: -24.0, longitude: -58.0 },
			Jujuy: { latitude: -24.0, longitude: -65.0 },
			LaPampa: { latitude: -36.0, longitude: -64.0 },
			LaRioja: { latitude: -29.0, longitude: -67.0 },
			Mendoza: { latitude: -32.0, longitude: -68.0 },
			Misiones: { latitude: -27.0, longitude: -55.0 },
			Neuquén: { latitude: -38.0, longitude: -70.0 },
			RíoNegro: { latitude: -39.0, longitude: -67.0 },
			Salta: { latitude: -24.0, longitude: -65.0 },
			SanJuan: { latitude: -31.0, longitude: -68.0 },
			SanLuis: { latitude: -33.0, longitude: -65.0 },
			SantaCruz: { latitude: -50.0, longitude: -67.0 },
			SantaFe: { latitude: -31.0, longitude: -60.0 },
			SantiagoDelEstero: { latitude: -28.0, longitude: -64.0 },
			TierraDelFuego: { latitude: -54.0, longitude: -67.0 },
			Tucumán: { latitude: -26.0, longitude: -65.0 },
		},
	},
	Bolivia: {
		latitude: -16.5,
		longitude: -68.1193,
		subDistricts: {
			Beni: { latitude: -14.0, longitude: -66.0 },
			Chuquisaca: { latitude: -19.0, longitude: -65.0 },
			Cochabamba: { latitude: -17.0, longitude: -66.0 },
			LaPaz: { latitude: -16.5, longitude: -68.1193 },
			Oruro: { latitude: -17.0, longitude: -67.0 },
			Pando: { latitude: -11.0, longitude: -68.0 },
			Potosí: { latitude: -19.0, longitude: -65.0 },
			SantaCruz: { latitude: -17.0, longitude: -63.0 },
			Tarija: { latitude: -21.0, longitude: -64.0 },
		},
	},
	Brazil: {
		latitude: -14.235,
		longitude: -51.9253,
		subDistricts: {
			Acre: { latitude: -9.0, longitude: -70.0 },
			Alagoas: { latitude: -9.0, longitude: -36.0 },
			Amapá: { latitude: -3.0, longitude: -51.0 },
			Amazonas: { latitude: -3.0, longitude: -60.0 },
			Bahia: { latitude: -12.0, longitude: -38.0 },
			Ceará: { latitude: -4.0, longitude: -40.0 },
			DistritoFederal: { latitude: -15.0, longitude: -47.0 },
			EspíritoSanto: { latitude: -20.0, longitude: -40.0 },
			Goiás: { latitude: -16.0, longitude: -49.0 },
			Maranhão: { latitude: -5.0, longitude: -45.0 },
			MatoGrosso: { latitude: -12.0, longitude: -55.0 },
			MatoGrossoDoSul: { latitude: -20.0, longitude: -54.0 },
			MinasGerais: { latitude: -20.0, longitude: -44.0 },
			Pará: { latitude: -4.0, longitude: -52.0 },
			Paraíba: { latitude: -7.0, longitude: -36.0 },
			Paraná: { latitude: -24.0, longitude: -51.0 },
			Pernambuco: { latitude: -8.0, longitude: -36.0 },
			Piauí: { latitude: -6.0, longitude: -43.0 },
			RioDeJaneiro: { latitude: -22.0, longitude: -43.0 },
			RioGrandeDoNorte: { latitude: -5.0, longitude: -36.0 },
			RioGrandeDoSul: { latitude: -30.0, longitude: -53.0 },
			Rondônia: { latitude: -10.0, longitude: -63.0 },
			Roraima: { latitude: -3.0, longitude: -61.0 },
			SantaCatarina: { latitude: -27.0, longitude: -50.0 },
			SãoPaulo: { latitude: -23.0, longitude: -47.0 },
			Sergipe: { latitude: -10.0, longitude: -37.0 },
			Tocantins: { latitude: -10.0, longitude: -48.0 },
		},
	},
	Chile: {
		latitude: -35.6751,
		longitude: -71.543,
		subDistricts: {
			AricaYParinacota: { latitude: -18.0, longitude: -70.0 },
			Tarapacá: { latitude: -20.0, longitude: -69.0 },
			Antofagasta: { latitude: -24.0, longitude: -69.0 },
			Atacama: { latitude: -25.0, longitude: -68.0 },
			Coquimbo: { latitude: -30.0, longitude: -71.0 },
			Valparaíso: { latitude: -33.0, longitude: -71.0 },
			Metropolitana: { latitude: -33.0, longitude: -70.0 },
			O_Higgins: { latitude: -34.0, longitude: -70.0 },
			Maule: { latitude: -35.0, longitude: -71.0 },
			Ñuble: { latitude: -36.0, longitude: -72.0 },
			Biobío: { latitude: -37.0, longitude: -73.0 },
			LaAraucanía: { latitude: -38.0, longitude: -72.0 },
			LosRíos: { latitude: -39.0, longitude: -73.0 },
			LosLagos: { latitude: -40.0, longitude: -73.0 },
			Aysén: { latitude: -45.0, longitude: -72.0 },
			Magallanes: { latitude: -54.0, longitude: -70.0 },
		},
	},
	Colombia: {
		latitude: 4.5709,
		longitude: -74.2973,
		subDistricts: {
			Amazonas: { latitude: -3.0, longitude: -70.0 },
			Antioquia: { latitude: 6.0, longitude: -75.0 },
			Arauca: { latitude: 7.0, longitude: -70.0 },
			Atlántico: { latitude: 10.0, longitude: -74.0 },
			Bolívar: { latitude: 10.0, longitude: -75.0 },
			Boyacá: { latitude: 5.0, longitude: -73.0 },
			Caldas: { latitude: 5.0, longitude: -75.0 },
			Caquetá: { latitude: 1.0, longitude: -75.0 },
			Casanare: { latitude: 5.0, longitude: -71.0 },
			Cauca: { latitude: 2.0, longitude: -76.0 },
			Cesar: { latitude: 10.0, longitude: -74.0 },
			Chocó: { latitude: 6.0, longitude: -77.0 },
			Córdoba: { latitude: 8.0, longitude: -75.0 },
			Cundinamarca: { latitude: 4.0, longitude: -74.0 },
			Guainía: { latitude: 2.0, longitude: -68.0 },
			Guaviare: { latitude: 2.0, longitude: -70.0 },
			Huila: { latitude: 2.0, longitude: -75.0 },
			LaGuajira: { latitude: 11.0, longitude: -72.0 },
			Magdalena: { latitude: 10.0, longitude: -74.0 },
			Meta: { latitude: 3.0, longitude: -73.0 },
			Nariño: { latitude: 1.0, longitude: -77.0 },
			NorteDeSantander: { latitude: 7.0, longitude: -72.0 },
			Putumayo: { latitude: 1.0, longitude: -76.0 },
			Quindío: { latitude: 4.0, longitude: -75.0 },
			Risaralda: { latitude: 5.0, longitude: -75.0 },
			SanAndrésYProvidencia: { latitude: 12.0, longitude: -81.0 },
			Santander: { latitude: 7.0, longitude: -73.0 },
			Sucre: { latitude: 9.0, longitude: -75.0 },
			Tolima: { latitude: 4.0, longitude: -75.0 },
			ValleDelCauca: { latitude: 3.0, longitude: -76.0 },
			Vaupés: { latitude: 0.0, longitude: -70.0 },
			Vichada: { latitude: 4.0, longitude: -67.0 },
		},
	},
	Ecuador: {
		latitude: -1.8312,
		longitude: -78.1834,
		subDistricts: {
			Azuay: { latitude: -2.0, longitude: -78.0 },
			Bolívar: { latitude: -1.0, longitude: -78.0 },
			Cañar: { latitude: -2.0, longitude: -78.0 },
			Carchi: { latitude: 0.0, longitude: -77.0 },
			Chimborazo: { latitude: -2.0, longitude: -78.0 },
			Cotopaxi: { latitude: -1.0, longitude: -78.0 },
			ElOro: { latitude: -3.0, longitude: -79.0 },
			Esmeraldas: { latitude: 0.0, longitude: -79.0 },
			Galápagos: { latitude: -0.0, longitude: -90.0 },
			Guayas: { latitude: -2.0, longitude: -79.0 },
			Imbabura: { latitude: 0.0, longitude: -78.0 },
			Loja: { latitude: -4.0, longitude: -79.0 },
			LosRíos: { latitude: -1.0, longitude: -79.0 },
			Manabí: { latitude: -1.0, longitude: -80.0 },
			MoronaSantiago: { latitude: -2.0, longitude: -78.0 },
			Napo: { latitude: -1.0, longitude: -77.0 },
			Pastaza: { latitude: -1.0, longitude: -77.0 },
			Pichincha: { latitude: -0.0, longitude: -78.0 },
			SantoDomingoDeLosTsáchilas: { latitude: -0.0, longitude: -79.0 },
			Sucumbíos: { latitude: 0.0, longitude: -77.0 },
			Tungurahua: { latitude: -1.0, longitude: -78.0 },
			ZamoraChinchipe: { latitude: -4.0, longitude: -78.0 },
		},
	},
	Paraguay: {
		latitude: -23.4422,
		longitude: -58.4438,
		subDistricts: {
			AltoParaguay: { latitude: -20.0, longitude: -58.0 },
			AltoParaná: { latitude: -25.0, longitude: -54.0 },
			Asunción: { latitude: -25.2637, longitude: -57.5759 },
			Boquerón: { latitude: -20.0, longitude: -60.0 },
			Caaguazú: { latitude: -25.0, longitude: -56.0 },
			Caazapá: { latitude: -27.0, longitude: -56.0 },
			Canindeyú: { latitude: -24.0, longitude: -55.0 },
			Central: { latitude: -25.0, longitude: -57.0 },
			Concepción: { latitude: -23.0, longitude: -57.0 },
			Cordillera: { latitude: -25.0, longitude: -57.0 },
			Guairá: { latitude: -25.0, longitude: -56.0 },
			Itapúa: { latitude: -27.0, longitude: -55.0 },
			Misiones: { latitude: -27.0, longitude: -55.0 },
			Ñeembucú: { latitude: -27.0, longitude: -58.0 },
			Paraguarí: { latitude: -25.0, longitude: -57.0 },
			PresidenteHayes: { latitude: -23.0, longitude: -58.0 },
			SanPedro: { latitude: -24.0, longitude: -57.0 },
		},
	},
	Peru: {
		latitude: -9.19,
		longitude: -75.0152,
		subDistricts: {
			Áncash: { latitude: -9.0, longitude: -77.0 },
			Apurímac: { latitude: -14.0, longitude: -73.0 },
			Arequipa: { latitude: -16.0, longitude: -71.0 },
			Ayacucho: { latitude: -13.0, longitude: -74.0 },
			Cajamarca: { latitude: -7.0, longitude: -78.0 },
			Callao: { latitude: -12.0, longitude: -77.0 },
			Cusco: { latitude: -13.0, longitude: -71.0 },
			Huancavelica: { latitude: -13.0, longitude: -75.0 },
			Huánuco: { latitude: -9.0, longitude: -76.0 },
			Ica: { latitude: -14.0, longitude: -75.0 },
			Junín: { latitude: -11.0, longitude: -75.0 },
			LaLibertad: { latitude: -8.0, longitude: -78.0 },
			Lambayeque: { latitude: -6.0, longitude: -79.0 },
			Lima: { latitude: -12.0, longitude: -77.0 },
			Loreto: { latitude: -4.0, longitude: -73.0 },
			MadreDeDios: { latitude: -12.0, longitude: -70.0 },
			Moquegua: { latitude: -17.0, longitude: -70.0 },
			Pasco: { latitude: -10.0, longitude: -75.0 },
			Piura: { latitude: -4.0, longitude: -81.0 },
			Puno: { latitude: -15.0, longitude: -70.0 },
			SanMartín: { latitude: -6.0, longitude: -76.0 },
			Tacna: { latitude: -18.0, longitude: -70.0 },
			Tumbes: { latitude: -4.0, longitude: -81.0 },
			Ucayali: { latitude: -8.0, longitude: -74.0 },
		},
	},
	Suriname: {
		latitude: 3.9193,
		longitude: -56.0278,
		subDistricts: {
			Brokopondo: { latitude: 4.0, longitude: -55.0 },
			Commewijne: { latitude: 5.0, longitude: -55.0 },
			Coronie: { latitude: 5.0, longitude: -56.0 },
			Marowijne: { latitude: 5.0, longitude: -54.0 },
			Nickerie: { latitude: 4.0, longitude: -56.0 },
			Para: { latitude: 5.0, longitude: -55.0 },
			Paramaribo: { latitude: 5.0, longitude: -55.0 },
			Saramacca: { latitude: 5.0, longitude: -56.0 },
			Sipaliwini: { latitude: 4.0, longitude: -56.0 },
			Wanica: { latitude: 5.0, longitude: -55.0 },
		},
	},
	Uruguay: {
		latitude: -32.5228,
		longitude: -55.7658,
		subDistricts: {
			Artigas: { latitude: -30.0, longitude: -56.0 },
			Canelones: { latitude: -34.0, longitude: -56.0 },
			CerroLargo: { latitude: -33.0, longitude: -54.0 },
			Colonia: { latitude: -34.0, longitude: -57.0 },
			Durazno: { latitude: -33.0, longitude: -56.0 },
			Flores: { latitude: -33.0, longitude: -57.0 },
			Florida: { latitude: -34.0, longitude: -56.0 },
			Lavalleja: { latitude: -34.0, longitude: -55.0 },
			Maldonado: { latitude: -34.0, longitude: -54.0 },
			Montevideo: { latitude: -34.0, longitude: -56.0 },
			Paysandú: { latitude: -32.0, longitude: -58.0 },
			RíoNegro: { latitude: -33.0, longitude: -57.0 },
			Rivera: { latitude: -30.0, longitude: -55.0 },
			Rocha: { latitude: -34.0, longitude: -54.0 },
			Salto: { latitude: -31.0, longitude: -57.0 },
			SanJosé: { latitude: -34.0, longitude: -57.0 },
			SanSalvador: { latitude: -34.0, longitude: -56.0 },
			Tacuarembó: { latitude: -31.0, longitude: -56.0 },
			TreintaYTres: { latitude: -33.0, longitude: -54.0 },
		},
	},
	Venezuela: {
		latitude: 6.4238,
		longitude: -66.5897,
		subDistricts: {
			Amazonas: { latitude: 0.0, longitude: -66.0 },
			Anzoátegui: { latitude: 8.0, longitude: -64.0 },
			Apure: { latitude: 7.0, longitude: -70.0 },
			Aragua: { latitude: 10.0, longitude: -67.0 },
			Barinas: { latitude: 8.0, longitude: -70.0 },
			Bolívar: { latitude: 6.0, longitude: -62.0 },
			Carabobo: { latitude: 10.0, longitude: -68.0 },
			Cojedes: { latitude: 9.0, longitude: -68.0 },
			DeltaAmacuro: { latitude: 8.0, longitude: -60.0 },
			Falcón: { latitude: 11.0, longitude: -69.0 },
			Guárico: { latitude: 9.0, longitude: -67.0 },
			Lara: { latitude: 9.0, longitude: -70.0 },
			Mérida: { latitude: 8.0, longitude: -71.0 },
			Miranda: { latitude: 10.0, longitude: -66.0 },
			Monagas: { latitude: 9.0, longitude: -63.0 },
			NuevaEsparta: { latitude: 10.0, longitude: -64.0 },
			Portuguesa: { latitude: 9.0, longitude: -69.0 },
			Sucre: { latitude: 9.0, longitude: -62.0 },
			Táchira: { latitude: 7.0, longitude: -72.0 },
			Trujillo: { latitude: 9.0, longitude: -70.0 },
			Yaracuy: { latitude: 10.0, longitude: -68.0 },
			Zulia: { latitude: 10.0, longitude: -72.0 },
		},
	},
	...
	Antarctica: {
		...
		longitude: 0.0,
		subDistricts: {
			AntarcticTreatySystem: { latitude: -90.0, longitude: 0.0 },
			RossDependency: { latitude: -77.0, longitude: 160.0 },
			BritishAntarcticTerritory: { latitude: -75.0, longitude: -0.0 },
			AustralianAntarcticTerritory: { latitude: -66.0, longitude: 140.0 },
			FrenchSouthernTerritories: { latitude: -50.0, longitude: 70.0 },
			ChileanAntarcticTerritory: { latitude: -60.0, longitude: -70.0 },
			ArgentineAntarctic: { latitude: -60.0, longitude: -70.0 },
		},
	},
};
...
// Define routes
router.get('/find-state', async (request) => {
	const { lat, long } = request.query;
	const latitude = parseFloat(lat);
	const longitude = parseFloat(long);

	if (isNaN(latitude) || isNaN(longitude)) {
		return new Response(JSON.stringify({ error: 'Please provide valid numeric values for latitude and longitude.' }), {
			status: 400,
	...
	for (const [country, coordinates] of Object.entries(Coordinates)) {
		...
		if (distance < minDistance) {
			...
			closestLocation = { type: 'country', name: foundCountry, distance };
		}

		// Check for states (sub-districts)
		if (coordinates.subDistricts) {
			for (const [state, stateData] of Object.entries(coordinates.subDistricts)) {
				const stateDistance = calculateDistance(latitude, longitude, stateData.latitude, stateData.longitude);
				...
				if (stateDistance < minDistance) {
					...
					foundDistrict = null;
					foundCountry = country.replace(/_/g, ' ');
					closestLocation = { type: 'state', name: foundRegion, distance: stateDistance };
				}

				// Check nested districts (cities)
				if (stateData.subDistricts) {
					for (const [district, districtCoords] of Object.entries(stateData.subDistricts)) {
						const districtDistance = calculateDistance(latitude, longitude, districtCoords.latitude, districtCoords.longitude);
						...
						if (districtDistance < minDistance) {
							...
							foundCountry = country.replace(/_/g, ' ');
							closestLocation = { type: 'district', name: foundDistrict, distance: districtDistance };
						}
					}
				}
			}
	...
	let response = { message: 'Location not found in our database' };
	if (closestLocation) {
		if (minDistance <= 25) {
			let locationString = '';
			if (foundDistrict) {
			...
			response = { location: locationString, distance: minDistance.toFixed(2) };
		} else {
			response = { message: 'No precise location found within 25km radius' };
		}
	}
...
router.get('/find-coordinates', async (request) => {
	const placeName = normalizePlaceName(request.query.place);
	...
	for (const [country, countryData] of Object.entries(Coordinates)) {
		...
		if (countryData.subDistricts) {
			for (const [state, stateData] of Object.entries(countryData.subDistricts)) {
				...
				if (stateData.subDistricts) {
					for (const [district, districtData] of Object.entries(stateData.subDistricts)) {
	...
	if (!coordinates) {
		return new Response(JSON.stringify({ error: 'Place name not found.' }), {
			status: 400,
			headers: { 'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*' },
		});
	}

	return new Response(JSON.stringify({ place: originalName, latitude: coordinates.latitude, longitude: coordinates.longitude }), {
		headers: { 'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*' },
	});
});
...
// Export default fetch event handler
export default {
	fetch: (request) =>
		router.handle(request).catch((err) => new Response(err.message, { status: 500, headers: { 'Access-Control-Allow-Origin': '*' } })),
};
